...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
	<div class="max-w-3xl mx-auto bg-white shadow rounded-lg p-8 border border-gray-100">
		...
		<div class="prose prose-blue max-w-none text-gray-600 space-y-6">
			...
			<section>
				<h2 class="text-xl font-semibold text-gray-800 mb-3">2. Data We Collect</h2>
				<p>
				...
				<ul class="list-disc pl-5 space-y-2 mt-2">
					...
					<li>
						<strong>Profile Data</strong> includes your username and password (hashed), your interests,
			...
			<section>
				<h2 class="text-xl font-semibold text-gray-800 mb-3">3. How We Use Your Data</h2>
				<p>
				...
				<p class="mt-4">
					<strong>Marketing:</strong> We may use your Identity, Contact, Technical, Usage and Profile
					Data to form a view on what we think you may want or need, or what may be of interest to you.
					You will receive marketing communications from us if you have requested information from us
					or purchased goods or services from us or if you provided us with your details when you entered
					a competition or registered for a promotion and, in each case, you have not opted out of receiving
					that marketing. You can ask us to stop sending you marketing messages at any time by logging
			...
			<section>
				<h2 class="text-xl font-semibold text-gray-800 mb-3">5. Contact Details</h2>
				<p>
