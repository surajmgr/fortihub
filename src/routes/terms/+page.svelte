...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
	<div class="max-w-3xl mx-auto bg-white shadow rounded-lg p-8 border border-gray-100">
		...
		<div class="prose prose-blue max-w-none text-gray-600 space-y-6">
			...
			<section>
				<h2 class="text-xl font-semibold text-gray-800 mb-3">2. Accounts</h2>
				<p>
			...
			<section>
				<h2 class="text-xl font-semibold text-gray-800 mb-3">3. Marketing and Communications</h2>
				<p>
					By creating an account, you agree to subscribe to newsletters, marketing or promotional
					materials and other information we may send. However, you may opt out of receiving any, or
					all, of these communications from us by following the unsubscribe link or instructions
					provided in any email we send or by managing your preferences in your account settings.
				</p>
			</section>
